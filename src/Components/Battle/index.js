...
import {addToScoreboard} from "../../actions/creators"
        ...
        intervalHero1 = setInterval(() => {
            ...
            setHp2(hp2 => {
                if (hp2 - hit < 0) {
                    stopGame()
                    setWin(1)
                    props.addToScoreboard({...hero1, win: true}, hero2)
                    return 0
                }
                return (hp2 - hit)
            })
        ...
        intervalHero2 = setInterval(() => {
            ...
            setHp1(hp1 => {
                if (hp1 - hit < 0) {
                    stopGame()
                    setWin(2)
                    props.addToScoreboard(hero1, {...hero2, win: true})
                    return 0
                }
                return (hp1 - hit)
            })
        ...
        <Container id="battle" header={<Header/>}>
            <div className="row d-flex justify-content-around align-items-center flex-wrap mh-100vh">
                ...
                <div className="d-flex flex-column align-items-center">
                    ...
                    { hero1 && hero2 && end &&
                        <Button className="mt-5" to="/scoreboard">Scoreboard</Button>
                    }
                </div>
...
export default connect(mapStateToProps, {addToScoreboard})(Battle);
